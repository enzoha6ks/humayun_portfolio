...
export const allVideoProjects: VideoProject[] = [
  ...
  
  {
    id: "Lb7f_JXwl1M",
    video_title:
      "Struggling to find right podcast topic?",
  ...
  },
  {
    id: "Bkwo54hscPM",
    video_title:
      "Real founder of Nike's founder",
    video_description: `humayun ahmed style storytelling video on wealth mindset and financial freedom.`,
    tags: ["Stress Relief", "Mental Health", "Wellness"],
  ...
  },
  {
    id: "cN7mP5RoinQ",
    video_title:
      "Why should businesses care about podcasting",
    video_description: ``,
    tags: ["tags", "Mental Health", "Wellness"],
    ...
    project_images: [],
    category: ["Explainer" , "Short Form Content"],
    duration: "1:00",
    software_used: ["Adobe Premiere Pro"],
  },
  ...
  },
  {
    ...
    project_images: [],
    category: ["Talking Head", "Explainer" , "Short Form Content"],
    duration: "6:58",
    software_used: ["Adobe Premiere Pro"],
  },
    {
    ...
    id: "dgW9kj8RAIg",
    video_title:
      "Why Men Are Afraid to Ask for HELP! w/ Maurico Verduzco",
    video_description: ``,
    tags: [ "Podcasts"],
    ...
    id: "EXqA2a2_lvM",
    video_title:
      "Following the Heart with Courage & Grace - Kathleen Saxton’s Journey to True Impact",
    video_description: ``,
    tags: [ "Podcasts"],
