        ...
        return __async(this, arguments, function*(payload, options = {}) {
            ...
            for (const email of payload){
                if (email.react) {
                    if (!this.renderAsync) {
                        try {
                            const { renderAsync } = yield __turbopack_context__.A("[project]/node_modules/resend/node_modules/@react-email/render/dist/node/index.mjs [app-route] (ecmascript, async loader)");
